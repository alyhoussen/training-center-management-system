...
# - Les cours/formations (pour rappel, cette structure est prévue)
...
// Assurez-vous que le fichier public/index.html contient bien un élément avec l'id "root"
...
const Payments = () => {
  ...
  // Chaque paiement enregistre également le nom de l'étudiant ayant payé
...
// Maintenant supporte une prop "className" supplémentaire pour personnaliser le style
...
/* Styles spécifiques pour les boutons d'édition et de suppression */
.btn-edit {
...
/* Amélioration du design des cartes */
.card {
  background: #fff;
  padding: 20px;
  border-radius: 8px;
...
/* Conteneur pour associer une carte et ses actions */
.card-container {
  margin-bottom: 20px;
}
